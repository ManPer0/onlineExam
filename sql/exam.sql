...
CREATE TABLE `admin`  (
  `admin_id` int(0) NOT NULL AUTO_INCREMENT COMMENT 'ID号',
  ...
  `pwd` varchar(254) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码',
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (9527, '超级管理员', '男', '13658377857', '1253838283@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '3132', '0');
...
CREATE TABLE `exam_manage`  (
  `exam_code` int(0) NOT NULL AUTO_INCREMENT COMMENT '考试编号',
  ...
  `total_time` int(0) NULL DEFAULT NULL COMMENT '持续时长',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20230017 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20230001, '2023年上期期末考试', '计算机网络', 1001, '2023-11-21', 120, '2023', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230002, '2023年上期期末考试', '数据库理论', 1002, '2023-11-21', 90, '2023', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230003, '2023年上期期末考试', '数据结构', 1003, '2023-11-22', 90, '2023', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230005, '2023年上期期末考试', '计算机导论', 1004, '2023-11-24', 90, '2023', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230006, '2023年上期期末考试', '软件工程', 1005, '2023-11-24', 120, '2023', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230007, '2023年上期期末考试', '操作系统', 1006, '2023-11-29', 120, '2023', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230008, '2023年上期期末考试', 'C语言', 1007, '2023-12-02', 120, '2023', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230009, '2023年上期期末考试', '高等数学', 1008, '2023-12-03', 90, '2023', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230018, 'test', 'test考试', 1009, '2024-02-07', 90, '4', NULL, '软件工程', '人工智能学院', 100, '期末考试', 'test');
INSERT INTO `exam_manage` VALUES (20230019, 'test', '数据库', 1010, '2024-02-11', 90, '4', NULL, '软件工程', '人工智能学院', 100, 'test', 'test');
...
CREATE TABLE `fill_question`  (
  `question_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '试题编号',
...
INSERT INTO `fill_question` VALUES (10029, '计算机网络', 'Q', 'Q', 'Q', 2, '1', 'Q');
INSERT INTO `fill_question` VALUES (10030, '数据结构', 'ttttest', 't', 'r', 2, '1', '1');
INSERT INTO `fill_question` VALUES (10031, '数据库理论', 'test', 't', 't', 2, '2', '1');
INSERT INTO `fill_question` VALUES (10032, '数据库理论', 'test', 't', 't', 2, '2', '1');
INSERT INTO `fill_question` VALUES (10033, '数据库理论', 'test', 't', 't', 2, '2', '1');
INSERT INTO `fill_question` VALUES (10034, '数据库理论', 'test', 't', 't', 2, '2', '1');
INSERT INTO `fill_question` VALUES (10035, '数据库理论', 'test', 't', 't', 2, '2', '1');
INSERT INTO `fill_question` VALUES (10036, '数据库理论', '她她她她她她', '他', 'test', 2, '3', '1');
INSERT INTO `fill_question` VALUES (10037, '数据库', '人多', '2', '', 2, '3', '3');
...
INSERT INTO `judge_question` VALUES (10013, '数据库理论', 'test', 'T', '', 2, '1', '1');
INSERT INTO `judge_question` VALUES (10014, '数据库', '永远永远', 'F', '', 2, '3', '4');
...
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '留言表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (2, '晚上加班,这感觉非常的nice', '今天是星期一的晚上,下班后回到宿舍继续写我的毕业设计,看着项目功能日渐丰满好开心哦,你们也要元气满满哦！', '2023-11-18');
INSERT INTO `message` VALUES (15, '咸鱼', '我是一条咸鱼', '2023-11-18');
INSERT INTO `message` VALUES (16, '今天中午吃什么', '今天去吃莲藕排骨汤吧，虽然也不好吃，但这里真的没什么东西可以吃了', '2023-11-18');
INSERT INTO `message` VALUES (20, '这个网站不错', '博主大大好厉害，网页看着很清新呢，喜欢这样嘞风格。', '2023-11-18');
INSERT INTO `message` VALUES (21, '男孩子', '哇，这么可爱，那肯定是男孩子呀。', '2023-11-18');
INSERT INTO `message` VALUES (22, '好人', '你是个好人，可是我们不合适。', '2023-11-18');
INSERT INTO `message` VALUES (25, '小乔', '花会枯萎，爱永不凋零，小乔要努力变强。', '2023-11-18');
INSERT INTO `message` VALUES (26, '妲己', '妲己会一直爱主人，因为被设定成这样，来和妲己玩耍吧。', '2023-12-04');
INSERT INTO `message` VALUES (27, '土味情话', '妈妈从小对我讲，不要早恋，遇到你以后，我决定不听妈妈的话了。', '2023-12-04');
INSERT INTO `message` VALUES (35, '贝塔', '开坦克', '2023-12-05');
INSERT INTO `message` VALUES (38, 'test', 'test', '2024-02-28');
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`question_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10036 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '选择题题库表' ROW_FORMAT = Dynamic;
...
INSERT INTO `multi_question` VALUES (10033, '计算机网络', 'test', 'test', 'test', 'test', 'test', 'B', 'test', 2, '1', '1');
INSERT INTO `multi_question` VALUES (10034, '计算机网络', 'test', 'test', 'test', 'test', 'test', 'B', 'test', 2, '1', '1');
INSERT INTO `multi_question` VALUES (10035, '数据库理论', 'test', 't', 'e', 's', 't', 'A', '', 2, '5', '2');
INSERT INTO `multi_question` VALUES (10036, '数据库理论', 'test', 't', 't', 't', 't', 'A', '', 2, '1', '1');
INSERT INTO `multi_question` VALUES (10037, '数据库理论', 'teeeest', 'tw', 'tet', 't', 'tt', 'D', NULL, 2, '2', '4');
INSERT INTO `multi_question` VALUES (10038, '数据库', 'test', '2', '34', '1', '4', 'C', '', 2, '3', '3');
...
CREATE TABLE `paper_manage`  (
  ...
  `question_id` int(0) NULL DEFAULT NULL COMMENT '题目编号'
...
INSERT INTO `paper_manage` VALUES (1001, 2, 10004);
INSERT INTO `paper_manage` VALUES (1001, 2, 10015);
INSERT INTO `paper_manage` VALUES (1001, 2, 10026);
INSERT INTO `paper_manage` VALUES (1001, 2, 10022);
...
INSERT INTO `paper_manage` VALUES (1001, 3, 10005);
INSERT INTO `paper_manage` VALUES (1002, 1, 10001);
INSERT INTO `paper_manage` VALUES (1002, 1, 10009);
INSERT INTO `paper_manage` VALUES (1002, 1, 10008);
INSERT INTO `paper_manage` VALUES (1002, 1, 10007);
INSERT INTO `paper_manage` VALUES (1002, 1, 10029);
...
INSERT INTO `paper_manage` VALUES (1002, 1, 10006);
INSERT INTO `paper_manage` VALUES (1002, 1, 10032);
INSERT INTO `paper_manage` VALUES (1002, 1, 10025);
INSERT INTO `paper_manage` VALUES (1002, 1, 10022);
INSERT INTO `paper_manage` VALUES (1002, 1, 10030);
INSERT INTO `paper_manage` VALUES (1002, 1, 10005);
INSERT INTO `paper_manage` VALUES (1002, 1, 10016);
INSERT INTO `paper_manage` VALUES (1002, 1, 10000);
INSERT INTO `paper_manage` VALUES (1002, 1, 10018);
INSERT INTO `paper_manage` VALUES (1002, 1, 10011);
INSERT INTO `paper_manage` VALUES (1002, 1, 10026);
INSERT INTO `paper_manage` VALUES (1002, 1, 10020);
INSERT INTO `paper_manage` VALUES (1002, 1, 10017);
INSERT INTO `paper_manage` VALUES (1002, 1, 10014);
INSERT INTO `paper_manage` VALUES (1002, 1, 10012);
INSERT INTO `paper_manage` VALUES (1002, 1, 10027);
INSERT INTO `paper_manage` VALUES (1002, 1, 10013);
INSERT INTO `paper_manage` VALUES (1002, 1, 10019);
INSERT INTO `paper_manage` VALUES (1002, 1, 10015);
INSERT INTO `paper_manage` VALUES (1002, 1, 10028);
INSERT INTO `paper_manage` VALUES (1002, 1, 10003);
INSERT INTO `paper_manage` VALUES (1002, 1, 10010);
INSERT INTO `paper_manage` VALUES (1002, 1, 10024);
INSERT INTO `paper_manage` VALUES (1002, 2, 10019);
INSERT INTO `paper_manage` VALUES (1002, 2, 10002);
INSERT INTO `paper_manage` VALUES (1002, 2, 10020);
INSERT INTO `paper_manage` VALUES (1002, 2, 10026);
INSERT INTO `paper_manage` VALUES (1002, 2, 10004);
INSERT INTO `paper_manage` VALUES (1002, 2, 10012);
INSERT INTO `paper_manage` VALUES (1002, 2, 10014);
INSERT INTO `paper_manage` VALUES (1002, 2, 10028);
INSERT INTO `paper_manage` VALUES (1002, 2, 10009);
INSERT INTO `paper_manage` VALUES (1002, 2, 10015);
...
INSERT INTO `paper_manage` VALUES (1002, 3, 10007);
INSERT INTO `paper_manage` VALUES (1002, 3, 10011);
INSERT INTO `paper_manage` VALUES (1002, 3, 10003);
INSERT INTO `paper_manage` VALUES (1002, 3, 10010);
INSERT INTO `paper_manage` VALUES (1002, 3, 10004);
INSERT INTO `paper_manage` VALUES (1002, 3, 10012);
INSERT INTO `paper_manage` VALUES (1002, 3, 10008);
INSERT INTO `paper_manage` VALUES (1002, 3, 10001);
INSERT INTO `paper_manage` VALUES (1002, 3, 10005);
INSERT INTO `paper_manage` VALUES (1002, 1, 10007);
INSERT INTO `paper_manage` VALUES (1002, 1, 10018);
INSERT INTO `paper_manage` VALUES (1002, 1, 10017);
INSERT INTO `paper_manage` VALUES (1002, 1, 10003);
...
INSERT INTO `paper_manage` VALUES (1002, 1, 10023);
INSERT INTO `paper_manage` VALUES (1002, 2, 10004);
INSERT INTO `paper_manage` VALUES (1002, 2, 10027);
INSERT INTO `paper_manage` VALUES (1002, 2, 10019);
INSERT INTO `paper_manage` VALUES (1002, 2, 10026);
INSERT INTO `paper_manage` VALUES (1002, 2, 10028);
INSERT INTO `paper_manage` VALUES (1002, 2, 10021);
INSERT INTO `paper_manage` VALUES (1002, 2, 10000);
INSERT INTO `paper_manage` VALUES (1002, 2, 10015);
INSERT INTO `paper_manage` VALUES (1002, 2, 10013);
INSERT INTO `paper_manage` VALUES (1002, 2, 10020);
INSERT INTO `paper_manage` VALUES (1002, 2, 10023);
INSERT INTO `paper_manage` VALUES (1002, 2, 10011);
INSERT INTO `paper_manage` VALUES (1002, 2, 10005);
INSERT INTO `paper_manage` VALUES (1002, 2, 10017);
INSERT INTO `paper_manage` VALUES (1002, 2, 10012);
INSERT INTO `paper_manage` VALUES (1002, 3, 10012);
INSERT INTO `paper_manage` VALUES (1002, 3, 10002);
INSERT INTO `paper_manage` VALUES (1002, 3, 10001);
...
INSERT INTO `paper_manage` VALUES (1001, 2, 10023);
INSERT INTO `paper_manage` VALUES (1001, 2, 10013);
INSERT INTO `paper_manage` VALUES (1001, 2, 10004);
...
INSERT INTO `paper_manage` VALUES (1001, 2, 10029);
INSERT INTO `paper_manage` VALUES (1001, 2, 10005);
INSERT INTO `paper_manage` VALUES (1001, 2, 10024);
INSERT INTO `paper_manage` VALUES (1001, 2, 10027);
INSERT INTO `paper_manage` VALUES (1001, 2, 10012);
INSERT INTO `paper_manage` VALUES (1001, 2, 10001);
INSERT INTO `paper_manage` VALUES (1001, 2, 10028);
INSERT INTO `paper_manage` VALUES (1001, 3, 10004);
...
INSERT INTO `paper_manage` VALUES (1002, 1, 10035);
INSERT INTO `paper_manage` VALUES (1002, 2, 10035);
...
INSERT INTO `paper_manage` VALUES (1002, 2, 10033);
INSERT INTO `paper_manage` VALUES (1002, 3, 10013);
INSERT INTO `paper_manage` VALUES (1002, 2, 10036);
INSERT INTO `paper_manage` VALUES (1002, 1, 10035);
INSERT INTO `paper_manage` VALUES (1002, 1, 10037);
INSERT INTO `paper_manage` VALUES (1002, 2, 10034);
INSERT INTO `paper_manage` VALUES (1002, 2, 10035);
INSERT INTO `paper_manage` VALUES (1002, 3, 10013);
INSERT INTO `paper_manage` VALUES (1010, 1, 10038);
INSERT INTO `paper_manage` VALUES (1010, 2, 10037);
INSERT INTO `paper_manage` VALUES (1010, 3, 10014);
INSERT INTO `paper_manage` VALUES (1010, 1, 10038);
INSERT INTO `paper_manage` VALUES (1010, 2, 10037);
INSERT INTO `paper_manage` VALUES (1010, 3, 10014);
...
CREATE TABLE `replay`  (
  `message_id` int(0) NULL DEFAULT NULL COMMENT '留言编号',
  `replay_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '回复编号',
...
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES (26, 3, '好呀，我来了，你别跑！', '2023-11-25');
INSERT INTO `replay` VALUES (22, 4, '心疼你2秒钟', '2023-11-25');
INSERT INTO `replay` VALUES (25, 5, '我也要变强', '2023-11-26');
INSERT INTO `replay` VALUES (25, 6, '俺也一样', '2023-11-26');
INSERT INTO `replay` VALUES (21, 7, '既然这样，那就迎男而上吧', '2023-11-27');
INSERT INTO `replay` VALUES (16, 8, '那条街确实没什么东西可以吃了。。。', '2023-11-28');
INSERT INTO `replay` VALUES (15, 9, '咸鱼其实还可以吃，而你,emmmm', '2023-11-28');
INSERT INTO `replay` VALUES (21, 11, '我不怕人多', '2023-11-29');
INSERT INTO `replay` VALUES (20, 12, '是嘞，还行。', '2023-11-29');
INSERT INTO `replay` VALUES (26, 13, '我也爱你ε=(´ο｀*)))唉', '2023-11-30');
INSERT INTO `replay` VALUES (27, 14, '你这个坏孩子', '2023-11-30');
INSERT INTO `replay` VALUES (33, 18, '是的，今天是周一。', '2023-12-04');
INSERT INTO `replay` VALUES (34, 19, '1111', '2023-12-05');
INSERT INTO `replay` VALUES (34, 20, '2222', '2023-12-05');
INSERT INTO `replay` VALUES (35, 21, '666', '2023-12-07');
INSERT INTO `replay` VALUES (35, 22, '啊', '2024-02-27');
INSERT INTO `replay` VALUES (36, 23, '她她她', '2024-02-27');
INSERT INTO `replay` VALUES (36, 24, '额', '2024-02-27');
INSERT INTO `replay` VALUES (36, 25, '蛮大人', '2024-02-27');
...
CREATE TABLE `score`  (
  `score_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '分数编号',
  `exam_code` int(0) NULL DEFAULT NULL COMMENT '考试编号',
  `student_id` bigint(0) NULL DEFAULT NULL COMMENT '学号',
  `subject` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '课程名称',
  `pt_score` int(0) NULL DEFAULT NULL COMMENT '平时成绩',
  `et_score` int(0) NULL DEFAULT NULL COMMENT '期末成绩',
...
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20230001, 202235720346, '计算机网络', NULL, 70, NULL, '2023-12-03');
INSERT INTO `score` VALUES (14, 20230002, 202235720346, '数据库理论', NULL, 78, NULL, '2023-12-04');
INSERT INTO `score` VALUES (31, 20230001, 202235720346, '计算机网络', NULL, 0, NULL, '2023-12-07');
INSERT INTO `score` VALUES (32, 20230001, 202235720346, '计算机网络', NULL, 0, NULL, '2023-12-08');
INSERT INTO `score` VALUES (33, 20230019, 202235720346, '数据库', NULL, 2, NULL, '2024-02-29');
INSERT INTO `score` VALUES (34, 20230019, 202235720346, '数据库', NULL, 2, NULL, '2024-02-29');
INSERT INTO `score` VALUES (35, 20230019, 202235720346, '数据库', NULL, 4, NULL, '2024-02-29');
...
CREATE TABLE `student`  (
  `student_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 202235720353 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '学生信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (202235720346, '蛮大人', '2023', '计算机科学与技术', '2', '软件工程学院', '13265647355', '185050687@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '124123124535', '男', '2');
INSERT INTO `student` VALUES (202235720347, '张大宝', '2023', '信息工程', '1', '软件工程学院', '13265647355', '185050687@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '3242342', '男', '2');
INSERT INTO `student` VALUES (202235720348, '翠花', '2023', '网络工程', '1', '软件工程学院', '13265647355', '185050687@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '2423423', '女', '2');
INSERT INTO `student` VALUES (202235720349, '小王', '2023', '信息工程', '2', '软件工程学院', '13265647355', '185050687@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '500234199704022353', '男', '2');
INSERT INTO `student` VALUES (202235720352, '蛮小满', '2022', '软件工程', '3', '人工智能', '13265647355', '185050687@qq.com', '14e1b600b1fd579f47433b88e8d85291', '411111111111111111', '男', '2');
...
CREATE TABLE `teacher`  (
  `teacher_id` int(0) NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20081021 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '教师信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20081001, '蛮大人', '软件工程学院', '男', '13265647355', '185050687@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '423423283498', '讲师', '1');
INSERT INTO `teacher` VALUES (20081002, '王大志', '软件工程学院', '男', '13265647355', '185050687@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '24241234', '讲师', '1');
