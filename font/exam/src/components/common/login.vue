        ...
        if(res.data != null) {
          switch(resData.role) {
            case "0":  //管理员
              ...
              this.$cookies.set("token-"+resData.adminId,res.headers.token)
            ...
            case "1": //教师
              ...
              this.$cookies.set("token-"+resData.teacherId,res.headers.token)
              this.$router.push({path: '/index' }) //跳转到教师用户
              break
            case "2": //学生
              this.$cookies.set("cname", resData.studentName)
              this.$cookies.set("cid", resData.studentId)
              this.$cookies.set("token-"+resData.studentId,res.headers.token)
