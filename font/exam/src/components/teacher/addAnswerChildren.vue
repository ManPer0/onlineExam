  ...
  methods: {
    ...
    create() {
      this.$axios({
        ...
        data: {
          ...
          subject: this.subject //'计算机网络' //题目数量太少，指定为计算机网络出题
        }
      }).then(res => {
        console.log(res)
        let data = res.data
    ...
    fillSubmit() { //填空题提交
      ...
      this.$axios({
        ...
        this.$axios(`/api/paper/fillQuestionId`).then(res => { //获取当前题目的questionId
          let questionId = res.data.data.questionId
          this.postPaper.questionId = questionId
    ...
    judgeSubmit() { //判断题提交
      ...
      this.$axios({
        ...
        this.$axios(`/api/paper/judgeQuestionId`).then(res => { //获取当前题目的questionId
          let questionId = res.data.data.questionId
          this.postPaper.questionId = questionId
